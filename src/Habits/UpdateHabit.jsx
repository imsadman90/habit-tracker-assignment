...
const UpdateHabit = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`http://localhost:5001/habits/${habit._id}`, {
      method: "PUT",
      ...
      <div className="card-body p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            className="input w-full rounded-full bg-gray-100"
          />
          <button type="submit" className="btn w-full bg-[#53c2ed] text-[#003c6b] hover:bg-[#6bb5db] transition-colors rounded-full mt-4">Update Habit</button>
        </form>
      </div>
    </div>
    </MotionLayout>
